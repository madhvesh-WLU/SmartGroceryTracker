...
public class searchGroceryItemsActiveBudgetServices {
     ...
     */
    public static void searchGroceryItemsAll(Context context, RequestQueue queue, String query, GroceryItemsFetchListener listener) {
        ...
        String url = Config.SEARCH_GROCERY_ACTIVE_BUDGETL + active_budget + "?query=" + query;
